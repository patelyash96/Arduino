...
<html>
  ...
  <body>
    ...
    <div>
      ...
      <button class="button" ontouchstart="start_timer_TC('HT')" ontouchend="stop_timer()" onmousedown="start_timer_MP('HM')" onmouseup="stop_timer()" onmouseleave="stop_timer()"><b>HI</b></br><b lang="ja-jp">ハイー</b></button>
      <div class="space"></div>
      <button class="button" ontouchstart="start_timer_TC('BT')" ontouchend="stop_timer()" onmousedown="start_timer_MP('BM')" onmouseup="stop_timer()" onmouseleave="stop_timer()"><b>BOW</b></br><b lang="ja-jp">お辞儀</b></button>
      <div class="space"></div>
      <button class="button" ontouchstart="start_timer_TC('DT')" ontouchend="stop_timer()" onmousedown="start_timer_MP('DM')" onmouseup="stop_timer()" onmouseleave="stop_timer()"><b>DANCE</b></br><b lang="ja-jp">ダンス</b></button>
      <br><br>
      <button class="button" ontouchstart="start_timer_TC('WT')" ontouchend="stop_timer()" onmousedown="start_timer_MP('WM')" onmouseup="stop_timer()" onmouseleave="stop_timer()"><b>WALK</b></br><b lang="ja-jp">歩く</b></button>
      <div class="space"></div>
      <button class="button" ontouchstart="start_timer_TC('PT')" ontouchend="stop_timer()" onmousedown="start_timer_MP('PM')" onmouseup="stop_timer()" onmouseleave="stop_timer()"><b>PHOTO POSE</b></br><b lang="ja-jp">写真 ポーズ</b></button>
      <div class="space"></div>
      <button class="button" ontouchstart="start_timer_TC('ST')" ontouchend="stop_timer()" onmousedown="start_timer_MP('SM')" onmouseup="stop_timer()" onmouseleave="stop_timer()"><b>STAND</b></br><b lang="ja-jp">立っつ</b></button>
    </div>
